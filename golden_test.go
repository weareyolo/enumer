...
func TestGolden(t *testing.T) {
	...
	for _, test := range goldenJSONAndSQL {
		runGoldenTest(t, test, true, false, false, true, false, false, false, false, "", "")
	}
...
func runGoldenTest(t *testing.T, test Golden,
	generateJSON, generateBSON, generateYAML, generateSQL, generateText, linecomment, generateGQLGen, generateValuesMethod bool,
	...
	g.generate(tokens[1], generateJSON, generateBSON, generateYAML, generateSQL, generateText, generateGQLGen, "noop", trimPrefix, prefix, linecomment, generateValuesMethod)
	got := string(g.format())
